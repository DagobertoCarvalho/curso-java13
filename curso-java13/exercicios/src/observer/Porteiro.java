...
public class Porteiro extends Thread {
	...
	private List<ChegadaAniversarianteObserver> observer = new ArrayList<ChegadaAniversarianteObserver>();
	...
	public void run() {
		...
		while(true) {
			...
			if(valor == 1) {
				...
				for(ChegadaAniversarianteObserver observer: this.observer) {
